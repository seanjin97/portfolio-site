const data = {
	projects: [
		{
			id: 1,
			title: 'Shipping Schedule Dashboard',
			para:
				'A full stack application that provides a simple dashboard to track shipping schedules.',
			imageSrc: 'https://i.ibb.co/sj1Fp8d/vessel.png',
			url: 'https://github.com/MatthewTan96/OOP',
			skills:
				'Java, Spring Boot, HTMl, CSS, JS, Hibernate, PostgreSQL, Java Mail, Keycloak',
		},
		{
			id: 2,
		...
		},
		{
			...
			imageSrc: 'https://i.ibb.co/ZcBqWbX/til.jpg',
			url: 'https://github.com/seanjin97/TIL2020_CompetitionEntry',
		...
		},
		{
			...
			imageSrc: 'https://i.ibb.co/wQmdrvQ/excelautomation.png',
			url: 'https://github.com/seanjin97/excelAutomationWithGUI',
		...
		},
		{
			...
			imageSrc: 'https://i.ibb.co/dLfRGdg/sentiment.png',
			url: 'https://github.com/seanjin97/Sentiment-Analysis-COVID19',
